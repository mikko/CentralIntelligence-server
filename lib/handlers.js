    ...
    langProcessor.tokenize(message)
        .then(analysis => {
            ...
            if (selectedClient === undefined) {
                ...
                console.log('Asking DDG');
                ddg.query(clientMessage.originalMessage, (err, res) => {
                    console.dir(res);
                    if (err || !res.AbstractText || res.AbstractText === '') {
                        ...
                        broker.replyMessage(clientPool.get(targetClient), res.AbstractText, context);
                    }
                });
